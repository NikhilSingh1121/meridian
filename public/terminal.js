...
TABS.markets = {
  ...
  async loadMacro() {
    // MACRO COMMAND — full macro analysis module (heatmap · zoomable charts ·
    // regime · yield curve). Falls back to the compact strip if absent.
...
async function bootTerminal() {
  ...
  showTab(["markets", "research", "earnings", "forensic", "models", "risk", "reports", "portfolio", "sector", "news", "calc", "learn", "library"].includes(start) ? start : "markets");
}
